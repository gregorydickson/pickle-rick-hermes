...
SKILLS=(pickle-rick pickle-rick-anatomy-park pickle-rick-meeseeks pickle-rick-meeseeks-zellij pickle-rick-microverse pickle-rick-portal-gun pickle-rick-council pickle-rick-jar pickle-rick-morty pickle-rick-morty-review pickle-rick-help pickle-rick-tmux pickle-rick-zellij pickle-rick-prd pickle-rick-refine-prd pickle-rick-retry pickle-rick-chaos pickle-rick-dot pickle-rick-dot-patterns pickle-rick-attract pickle-rick-standup pickle-rick-szechuan-sauce)
...
echo "  pickle-rick-anatomy-park — Memory palace for long-context PRDs"
echo "  pickle-rick-meeseeks   — Iterative code review"
echo "  pickle-rick-meeseeks-zellij — Meeseeks in Zellij layout"
...
echo "  pickle-rick-morty-review — Morty review worker"
echo "  pickle-rick-help       — Show all commands"
echo "  pickle-rick-tmux       — Launch in tmux"
echo "  pickle-rick-zellij     — Launch in Zellij"
echo "  pickle-rick-prd        — Interactive PRD drafter"
echo "  pickle-rick-refine-prd — Refine PRDs with subagents"
echo "  pickle-rick-retry      — Retry failed tickets"
echo "  pickle-rick-chaos      — Chaos engineering"
echo "  pickle-rick-dot        — Convert PRD to DOT digraph"
echo "  pickle-rick-dot-patterns — DOT pipeline patterns"
echo "  pickle-rick-attract    — Submit DOT to attractor"
echo "  pickle-rick-standup    — Standup summary"
echo "  pickle-rick-szechuan-sauce — Sauce scoring"
echo ""
